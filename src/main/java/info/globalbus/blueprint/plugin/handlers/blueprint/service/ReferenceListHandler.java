...
public class ReferenceListHandler implements CustomDependencyAnnotationHandler<ReferenceList> {
    ...
    @Override
    public String handleDependencyAnnotation(final Class<?> clazz, ReferenceList referenceList, String name,
        ContextEnricher contextEnricher) {
        if (clazz != List.class) {
    ...
    private XmlWriter getXmlWriter(final String id, final ReferenceList referenceList,

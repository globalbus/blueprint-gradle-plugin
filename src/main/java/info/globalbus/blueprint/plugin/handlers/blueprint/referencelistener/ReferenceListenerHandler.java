 ...
 * under the License.
 */
package info.globalbus.blueprint.plugin.handlers.blueprint.referencelistener;
...
public class ReferenceListenerHandler implements BeanAnnotationHandler<ReferenceListener> {
    ...
    public void handleBeanAnnotation(AnnotatedElement annotatedElement, String id,
        ...
        String bindMethod = annotation.bindMethod().isEmpty()
            ? getAnnotatedMethodName(referenceListenerClass, Bind.class) : annotation.bindMethod();
        String unbindMethod = annotation.unbindMethod().isEmpty()
            ? getAnnotatedMethodName(referenceListenerClass, Unbind.class) : annotation.unbindMethod();
    ...
    private void createReference(final String referenceBeanName,
        ...
        contextEnricher.addBlueprintContentWriter("referenceWithReferenceListener/" + referenceBeanName + "/"
                                                  + referenceListenerDefinition.ref, xmlStreamWriter -> {
            ...
            writeReferenceListener(xmlStreamWriter, referenceListenerDefinition);
    ...
    private void createReferenceList(final String referenceBeanName,
                                     ...
                                     final ReferenceListener annotation,
                                     ContextEnricher contextEnricher) {
        contextEnricher.addBlueprintContentWriter("referenceListWithReferenceListener/" + referenceBeanName
                                                  + "/" + referenceListenerDefinition.ref, xmlStreamWriter -> {
    ...
    private void writeReferenceListener(XMLStreamWriter xmlStreamWriter,
        ReferenceListenerDefinition referenceListenerDefinition) throws XMLStreamException {

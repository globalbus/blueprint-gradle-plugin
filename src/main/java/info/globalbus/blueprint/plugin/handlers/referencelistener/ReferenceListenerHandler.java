...
public class ReferenceListenerHandler implements BeanAnnotationHandler<ReferenceListener> {
    ...
    private void createReference(final String referenceBeanName,
        ...
        contextEnricher.addBlueprintContentWriter("referenceWithReferenceListener/" + referenceBeanName + "/" + referenceListenerDefinition.ref, xmlStreamWriter -> {
    ...
    private void createReferenceList(final String referenceBeanName,
                                     ...
                                     final ReferenceListener annotation,
                                     ContextEnricher contextEnricher) {
        contextEnricher.addBlueprintContentWriter("referenceListWithReferenceListener/" + referenceBeanName + "/" + referenceListenerDefinition.ref, xmlStreamWriter -> {

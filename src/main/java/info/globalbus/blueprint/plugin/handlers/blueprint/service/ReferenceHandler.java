...
public class ReferenceHandler implements CustomDependencyAnnotationHandler<Reference> {
    ...
    @Override
    public String handleDependencyAnnotation(AnnotatedElement annotatedElement, String name,
    ...
    @Override
    public String handleDependencyAnnotation(final Class<?> clazz, Reference reference, String name,
        ContextEnricher contextEnricher) {
        ...
        contextEnricher.addBlueprintContentWriter(getWriterId(id, clazz), getXmlWriter(id, clazz, reference,
            contextEnricher));
    ...
    private XmlWriter getXmlWriter(final String id, final Class<?> clazz, final Reference reference,

...
public class ServiceHandler implements BeanAnnotationHandler<Service> {
    ...
    @Override
    public void handleBeanAnnotation(final AnnotatedElement annotatedElement, final String id,
        ...
        contextEnricher.addBlueprintContentWriter("service/" + id, writer -> {
    ...
    private String autoExport(AutoExport autoExport) {
        switch (autoExport) {
            ...
            default:
                throw new IllegalStateException("unknown " + autoExport);
        }
    }

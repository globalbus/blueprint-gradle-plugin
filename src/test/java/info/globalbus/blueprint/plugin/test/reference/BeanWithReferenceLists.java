 ...
 * under the License.
 */
package info.globalbus.blueprint.plugin.test.reference;
...
public class BeanWithReferenceLists {
    ...
    @Inject
    @ReferenceList(referenceInterface = Ref1.class, filter = "(a=453)", componentName = "r1", availability =
    ...
    @Inject
    @ReferenceList(referenceInterface = Ref2.class, filter = "(b=453)", componentName = "r2", availability =
        Availability.OPTIONAL)
    public void setRef2SetterFull(List<Ref2> ref) {
    }

    @Inject
    @ReferenceList(referenceInterface = Ref2.class, componentName = "blablabla", memberType =
        MemberType.SERVICE_REFERENCE)
    ...
    public BeanWithReferenceLists(
        ...
        @ReferenceList(referenceInterface = Ref2.class, availability = Availability.OPTIONAL, memberType =
            MemberType.SERVICE_REFERENCE) List<ServiceReference<Ref2>> ref2,
        ...
        @ReferenceList(referenceInterface = Ref1.class, availability = Availability.OPTIONAL) @Named("ref1ListForCons"
        ) List<Ref1> ref1Named
    ) {
    }
    ...
    public String create(
        ...
        @ReferenceList(referenceInterface = Ref3.class, filter = "(y=3)", componentName = "compForProduces",
            memberType = MemberType.SERVICE_REFERENCE) List<Ref3> ref3fc,
